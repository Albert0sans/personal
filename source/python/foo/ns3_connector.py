...
def runns3(waf_path="$HOME/ns3/ns-allinone-3.30/ns-3.30/",sim_file="scratch/prueba",num_aps=1,num_stas=1,simtime=5):
  subprocess.run("%s./waf --run '%s' %d %d %d "%(waf_path,sim_file,num_aps,num_stas,simtime),shell=True)
